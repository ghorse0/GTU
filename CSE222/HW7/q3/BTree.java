 ...
 * path from the root to a leaf is constant.
 *
 * @author Koffman and Wolfgang
 */
public class BTree<E extends Comparable<E>> implements SearchTree<E>, BenchI<E> {
    public BTree() {
        super();
    }
    // Nested class
    ...
    private static class Node<E> {
         ...
         * data[i] for i < size and to the subtree of children > data[size-1] for i ==
         * size
         */
    ...
    /**
     * Insert an Object into the tree. Inserted item must implement the Comparable
     * interface
     *
    ...
    /**
     * Recursive insert an Object into the Tree. Inserted item must implement the
     * Comparable interface
     *
     * @param root - The local root
     * @param item - The item to be inserted
     * @return true if the item was inserted, false if the item is already in the
     *         tree
     */
