...
public class AVLTreeSet< E
    ...
    /** Recursive delete method. Removes the given object
     from the AVL tree.
     The object is not in the tree and removeReturn
    ...
    public ArrayList<E> toList(ArrayList<E> lst){
        return toList((AVLNode<E>) root, lst);
    }
    ...
    /**
     * Returns iterator as elements are sorted.
     * @return
     */
    @Override
    public Iterator<E> iterator(){
        return new AVLSetIterator();
    }

    /**
     * headSet view of set, inclusive determines if toElement is included
     * @param toElement
     * @param inclusive
     * @return
     */
    ...
    /**
     * tailSet view of set, inclusive determines if toElement is included
     * @param fromElement
     * @param inclusive
     * @return
     */
